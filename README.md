...
```
net install psmatch2, from(https://raw.githubusercontent.com/eleuven/psmatch2/master/versions/v4.1.0) replace
...
> E. Leuven and B. Sianesi. (2003). "PSMATCH2: Stata module to perform full Mahalanobis matching and a variety of propensity score matching methods to adjust for pre-treatment observable differences between a group of treated and a group of untreated". http://ideas.repec.org/c/boc/bocode/s432001.html. This version 4.1.0.
